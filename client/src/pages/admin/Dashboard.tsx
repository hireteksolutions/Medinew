...
import { LayoutDashboard, Users, Calendar, UserCheck, Menu, X, FileText, Settings as SettingsIcon, LogOut } from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  const menuItems = [
    { path: DASHBOARD_ROUTES.ADMIN.OVERVIEW, icon: LayoutDashboard, label: 'Overview' },
    { path: DASHBOARD_ROUTES.ADMIN.DOCTORS, icon: UserCheck, label: 'Doctors' },
    { path: DASHBOARD_ROUTES.ADMIN.PATIENTS, icon: Users, label: 'Patients' },
    { path: DASHBOARD_ROUTES.ADMIN.APPOINTMENTS, icon: Calendar, label: 'Appointments' },
    { path: DASHBOARD_ROUTES.ADMIN.REPORTS, icon: FileText, label: 'Reports & Analytics' },
    { path: DASHBOARD_ROUTES.ADMIN.SETTINGS, icon: SettingsIcon, label: 'Settings' },
  ];

  const closeSidebar = () => setSidebarOpen(false);
  
  const userFullName = user ? `${user.firstName} ${user.lastName}` : 'Admin';
