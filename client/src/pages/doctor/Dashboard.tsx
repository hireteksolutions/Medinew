...
import { LayoutDashboard, Calendar, Users, Settings, Menu, X, LogOut } from 'lucide-react';
...
export default function DoctorDashboard() {
  ...
  const menuItems = [
    { path: DASHBOARD_ROUTES.DOCTOR.OVERVIEW, icon: LayoutDashboard, label: 'Overview' },
    { path: DASHBOARD_ROUTES.DOCTOR.APPOINTMENTS, icon: Calendar, label: 'Appointments' },
    { path: DASHBOARD_ROUTES.DOCTOR.PATIENTS, icon: Users, label: 'Patients' },
    { path: DASHBOARD_ROUTES.DOCTOR.SCHEDULE, icon: Calendar, label: 'Schedule' },
    { path: DASHBOARD_ROUTES.DOCTOR.PROFILE, icon: Settings, label: 'Profile' },
  ];

  const closeSidebar = () => setSidebarOpen(false);
  
  const userFullName = user ? `Dr. ${user.firstName} ${user.lastName}` : 'Doctor';
